...
var SandBoxService = /** @class */ (function () {
    ...
    SandBoxService.prototype.sandBoxOn = function () {
        return "SandBox Service is working";
    };
    SandBoxService.prototype.compareExcel = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, workbook.xlsx.readFile('/src/sandbox/excela.xlsx')];
                    case 1:
                        _a.sent();
                        worksheet = workbook.getWorksheet('결제내역');
